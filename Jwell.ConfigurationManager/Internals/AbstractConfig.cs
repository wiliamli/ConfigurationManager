...
namespace Jwell.ConfigurationManager.Internals
{
    public abstract class AbstractConfig : IConfig
    {
        ...
        public int? GetIntProperty(string key, int? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetIntProperty for {key} failed, return default value {defaultValue:D}", ex));
                return defaultValue;
            }
        }
        ...
        public long? GetLongProperty(string key, long? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetLongProperty for {key} failed, return default value {defaultValue:D}", ex));
                return defaultValue;
            }
        }
        ...
        public short? GetShortProperty(string key, short? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetShortProperty for {key} failed, return default value {defaultValue:D}", ex));
                return defaultValue;
            }
        }
        ...
        public float? GetFloatProperty(string key, float? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetFloatProperty for {key} failed, return default value {defaultValue:F}", ex));
                return defaultValue;
            }
        }
        ...
        public double? GetDoubleProperty(string key, double? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetDoubleProperty for {key} failed, return default value {defaultValue:F}", ex));
                return defaultValue;
            }
        }
        ...
        public sbyte? GetByteProperty(string key, sbyte? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetByteProperty for {key} failed, return default value {defaultValue:G}", ex));
                return defaultValue;
            }
        }
        ...
        public bool? GetBooleanProperty(string key, bool? defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetBooleanProperty for {key} failed, return default value {defaultValue}", ex));
                return defaultValue;
            }
        }
        ...
        public string[] GetArrayProperty(string key, string delimiter, string[] defaultValue)
        {
            ...
            {
                Logger.Error(new JwellConfigException($"GetArrayProperty for {key} failed, return default value", ex));
                return defaultValue;
            }
        }
