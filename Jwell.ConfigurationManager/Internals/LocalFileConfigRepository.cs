...
namespace Jwell.ConfigurationManager.Internals
{
    public class LocalFileConfigRepository : AbstractConfigRepository, IRepositoryChangeListener
    {
        ...
        private Properties LoadFromLocalCacheFile(string baseDir, string namespaceName)
        {
            ...
            {
                throw new JwellConfigException("Basedir cannot be empty");
            }
            ...
            {
                throw new JwellConfigException($"Loading config from local cache file {file} failed", ex);
            }
        ...
        private void PrepareConfigCacheDir()
        {
            ...
            {
                Logger.Warn(new JwellConfigException("Prepare config cache dir failed", ex));
                return;
            }
